---
title: "Standing Up Wazuh: A SIEM From Scratch in My Homelab"
description: A front-to-back lab wiring Wazuh into my Proxmox stack, touching on agent/manager fundamentals through custom rules, active response, and ntfy alerts.
date: 2026-06-26
tags: [wazuh, siem, homelab, blue-team, detection, proxmox, lab]
toc: true
---

> **Note to me / anyone following this:** this is written as a learning log, not a polished runbook. The runbook version would be in `/runbooks` once I've done this twice.
