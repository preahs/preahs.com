...
slug: guide-intro-to-social-blogging
published_date: 2025-10-07T20:44:00+00:00
tags: 2025, blogging, guides
publish: true
make_discoverable: true
is_page: false
meta_description: A general guide to getting started blogging for the purpose of creating a social network, AKA Blog Feeds.
...
I don't expect anyone to drop their social media. Plenty of people use it in healthy ways. We even have decentralized social media, such as the [fediverse](tab:https://jointhefediverse.net) (think Mastodon) and the [AT Protocol](tab:https://atproto.com/guides/faq) (think Bluesky) to reduce the problem of one person or company owning everything. I think this helps, and seeing a feed of your friends' short thoughts or posts occasionally is nice if you're not endlessly scrolling. I also think it's vital to many people to be able to explore recommendations frequently to get out of their bubble and experience variety.
...
You write a post. This post tends to be in Markdown, which is a markup language (like HTML) for creating formatted text. It's actually not too far from something like Microsoft Word. In this case, if you want a header, you can put a pound symbol `#` in front of your header text to tell your site that it should be formatted as one. Same with quotation blocks, bolding, italics and all that. Here is a simple [Markdown cheatsheet provided by Bear Blog.](tab:https://herman.bearblog.dev/markdown-cheatsheet/) Some other blogging platforms have even more options for formatting, like informational or warning boxes.

![Examples of using Markdown](https://preahs.com/assets/images/markdownexamples.png)

After you've written it, you can usually preview it before posting. While you're writing, you might want to use a [live-preview](tab:https://markdownlivepreview.com/) to make sure you're formatting it how you intend. After posting, people can go read your post and possibly interact with it in some ways if you want that.
...
That's all from me for now. [Subscribe to my RSS feed](https://blog.preahs.com/feed/), email me using the button at the bottom to tell me this post sucks, or that it's great, or if you have something to suggest to edit it, and **bring back the old web.**
___
<div class="reply-button-container">
  <a class="reply-button" href="mailto:preah@preahs.com?subject=Re:%20{{ post_title }}">Reply via email</a>
</div>
...
[^1]: **Washington Post** – *Five points for anger, one for a ‘like’: How Facebook’s formula fostered rage and misinformation.* [Link](tab:https://www.washingtonpost.com/technology/2021/10/26/facebook-angry-emoji-algorithm/). • [Unpaywalled](tab:http://archive.today/vULTo).

[^2]: **The Guardian** – *Facebook reveals news feed experiment to control emotions.* [Link](tab:https://www.theguardian.com/technology/2014/jun/29/facebook-users-emotions-news-feeds).

[^3]: This website was created by Steve, who has their own [Bear Blog](tab:https://stevedylandev.bearblog.dev/). Read [Resurrect the Old Web](tab:https://stevedylandev.bearblog.dev/resurrect-the-old-web/), which inspired this post.
...
[^5]: Take a look at this [Reddit discussion on why less JavaScript can be better](tab:https://www.reddit.com/r/webdev/comments/mfnxnj/why_your_website_should_work_without_javascript/).
