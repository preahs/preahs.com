...
slug: i-made-a-script-to-automate-updating-my-feeds-list
published_date: 2026-01-08T06:00:00+00:00
tags: 2026, guides, short
publish: true
make_discoverable: true
is_page: false
meta_description: I wrote a Python script to read a portion of my .opml file and output a markdown-friendly version.
meta_image: https://preahs.com/assets/images/meta-image.png
---

Today I made a Python script to make my life a little easier when it comes to updating my [Feeds](https://blog.preahs.com/feeds/) page. I follow and un-follow blogs occasionally, so exporting that and then writing it up in Markdown is kind of a bummer.
...
[opml_to_markdown.py](https://sipp.so/s/ujDOzxN7SA)
```
